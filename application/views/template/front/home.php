            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> <img src="<?php echo base_url(); ?>assets/template/front/img/logo.png" alt="logo"> </a>
                        ...
                        <div class="single_banner_slider">
                            <div class="row">
                                ...
                                <div class="banner_img d-none d-lg-block">
                                    <img src="<?php echo base_url(); ?>assets/template/front/img/banner_img.png" alt="">
                                </div>
                            </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-7 col-sm-6">
                    <div class="single_feature_post_text">
                        ...
                        <img src="<?php echo base_url(); ?>assets/template/front/img/feature/feature_1.png" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-sm-6">
                    <div class="single_feature_post_text">
                        ...
                        <h3>Latest foam Sofa</h3>
                        <a href="#" class="feature_btn">EXPLORE NOW <i class="fas fa-play"></i></a>
                        <img src="<?php echo base_url(); ?>assets/template/front/img/feature/feature_2.png" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-sm-6">
                    <div class="single_feature_post_text">
                        ...
                        <h3>Latest foam Sofa</h3>
                        <a href="#" class="feature_btn">EXPLORE NOW <i class="fas fa-play"></i></a>
                        <img src="<?php echo base_url(); ?>assets/template/front/img/feature/feature_3.png" alt="">
                    </div>
                </div>
                <div class="col-lg-7 col-sm-6">
                    <div class="single_feature_post_text">
                        ...
                        <h3>Latest foam Sofa</h3>
                        <a href="#" class="feature_btn">EXPLORE NOW <i class="fas fa-play"></i></a>
                        <img src="<?php echo base_url(); ?>assets/template/front/img/feature/feature_4.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single_product_item">
                                        <img src="<?php echo base_url(); ?>assets/template/front/img/product/product_1.png" alt="">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single_product_item">
                                        <img src="<?php echo base_url(); ?>assets/template/front/img/product/product_2.png" alt="">
                                        <div class="single_product_text">
                                            <h4>Quartz Belt Watch</h4>
                                            <h3>$150.00</h3>
                                            <a href="#" class="add_cart">+ add to cart<i class="ti-heart"></i></a>
