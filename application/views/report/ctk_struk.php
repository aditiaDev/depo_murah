...
<div id="container">
    ...
    <table border="1" style="width:100%;font-size:10px;border: 1px solid #ddd;border-collapse: collapse;">
      ...
      ?>
        <tr>
          ...
          <td style="text-align:right;"><?= $row['harga_barang']; ?></td>
      ...
      <tfoot>
        <tr>
          ...
          <td style="text-align:right;"><?= number_format($data[0]['tot_harga_barang'],0,',','.'); ?></td>
        </tr>
        <tr>
          <td colspan="4" style="text-align:center;">Penggunaan Point</td>
          <td style="text-align:right;"><?= number_format($data[0]['diskon'],0,',','.'); ?></td>
        </tr>
        <tr>
    ...
    <p style="text-align:center;font-size:10px;">Terima kasih telah Berbelanja di Depo Murah</p>
</div>
