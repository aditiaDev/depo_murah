              ...
              <div class="col-md-12">
                <table class="table table-bordered table-hover table-striped" id="tb_data">
                  <thead>
                    ...
                    <th class="text-center">Potongan dari Point</th>
  ...
  function REFRESH_DATA(){
    ...
    tb_data =  $("#tb_data").DataTable({
        ...
        "columns": [
            ...
            { "data": null, 
              "render" : function(data){
                return "<button class='btn btn-sm btn-danger' title='Hapus Data' onclick='deleteData(\""+data.id_penjualan+"\");'>Hapus </button>"
              },
